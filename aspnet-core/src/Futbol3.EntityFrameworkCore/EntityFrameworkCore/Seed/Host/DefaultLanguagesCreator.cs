...
namespace Futbol3.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly Futbol3DbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = Futbol3Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Futbol3DbContext context)
        {
            _context = context;
        }
