...
{
    public abstract class Futbol3WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Futbol3WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Futbol3WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Futbol3DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Futbol3DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Futbol3DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Futbol3DbContext, Task<T>> func)
        {
            T result;
