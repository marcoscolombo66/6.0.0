...
@Injectable()
export class EquiposServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<EquipoDto> {
        let url_ = this.baseUrl + "/api/services/app/Equipos/Get?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<EquipoDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<EquipoDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<EquipoDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<EquipoDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<EquipoDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Equipos/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<EquipoDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<EquipoDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<EquipoDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = EquipoDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<EquipoDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: EquipoDto | undefined): Observable<EquipoDto> {
        let url_ = this.baseUrl + "/api/services/app/Equipos/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<EquipoDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: EquipoDto | undefined): Observable<EquipoDto> {
        let url_ = this.baseUrl + "/api/services/app/Equipos/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<EquipoDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Equipos/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class EquipoDto implements IEquipoDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.nombre_equipo = _data["nombre_equipo"];
            this.categoria = _data["categoria"];
            this.campeonatos = _data["campeonatos"];
            this.id = _data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["nombre_equipo"] = this.nombre_equipo;
        data["categoria"] = this.categoria;
        data["campeonatos"] = this.campeonatos;
        data["id"] = this.id;
        return data; 
    }
...
export class EquipoDtoPagedResultDto implements IEquipoDtoPagedResultDto {
    totalCount: number;
    items: EquipoDto[] | undefined;

    constructor(data?: IEquipoDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(EquipoDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): EquipoDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new EquipoDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IEquipoDtoPagedResultDto {
    totalCount: number;
    items: EquipoDto[] | undefined;
}
